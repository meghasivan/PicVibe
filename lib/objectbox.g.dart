...
import 'app/model/imageFiles.dart';
import 'app/model/userDBModel.dart';

export 'package:objectbox/objectbox.dart'; // so that callers only have to import this file

final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 8552126460576003009),
      name: 'UserDetails',
      lastPropertyId: const IdUid(5, 3833971299811953620),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 7177405351298956989),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8159288889908096404),
            name: 'displayName',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 4065665874227546112),
            name: 'email',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 2509920761691302568),
            name: 'uid',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 3833971299811953620),
            name: 'photoURL',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 8304382514647320880),
      name: 'ImageFiles',
      lastPropertyId: const IdUid(3, 5631097148137709746),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 8136668588878682489),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8435695904568623736),
            name: 'fileData',
            type: 23,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 5631097148137709746),
            name: 'uid',
            type: 6,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 8304382514647320880),
